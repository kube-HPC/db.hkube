 ...
 * @typedef {Omit<typeof config.Algorithms.Store, 'indices'>} ConfigReference
 * @typedef {Omit<typeof config.Algorithms.Store.indices[0], 'name'>} Index
 * @typedef {ConfigReference & { indices: Index[] }} CollectionConfig
 */
