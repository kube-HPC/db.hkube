...
const ReadMeAlgorithms = require('./readme/Algorithms');
const ReadMePipelines = require('./readme/Pipelines');
...
class MongoDB {
    ...
    async init() {
        ...
        // console.log(`mongodb is now connected to ${this.client.s.url}, db: ${this.dbName}`);
        ...
        this.readme = {
            algorithms: new ReadMeAlgorithms(this.db, this.client),
            pipelines: new ReadMePipelines(this.db, this.client),
        };
        this.webhooks = {
        ...
        await this.readme.algorithms.init();
        await this.readme.pipelines.init();
